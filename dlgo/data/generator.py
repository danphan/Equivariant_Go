...
class DataGenerator:
    def __init__(self, data_directory, samples):
        ...
        self.files = set(file_name for file_name, index in samples) #remember that each file has many games, hence the index specification
    ...
    def _generate(self, batch_size, num_classes):
        for zip_file in self.files:
            file_name = zip_file.replace('.tar.gz','')+'train'
